...
// Remove null bytes e demais caracteres de controle — o Postgres rejeita
//  em colunas text ("unsupported Unicode escape sequence"). Os CSVs de extrato
// bancário do TSE (latin-1) ocasionalmente trazem esses bytes em campos de descrição.
