...
export const FEDERAL_CONFIG: SiteConfig = {
  ...
  nav: [
    ...
    },
    {
      label: "Minas Gerais",
      children: [
        { label: "▸ Painel do Executivo de MG", href: "/mg" },
        ...
        { label: "Sobrepreço em licitações", href: "/mg/licitacoes" },
        { label: "Notas fiscais por fornecedor", href: "/mg/notas" },
        { label: "Compras por fornecedor", href: "/mg/compras" },
        { label: "Obras (DER)", href: "/mg/obras" },
        { label: "Compras COVID", href: "/mg/covid" },
        { label: "Terceirizados", href: "/mg/terceirizados" },
        { label: "Organizações sociais (OSs)", href: "/mg/organizacoes-sociais" },
        { label: "Convênios de saída", href: "/mg/convenios" },
        { label: "Convênios de entrada", href: "/mg/convenios-entrada" },
        { label: "Emendas federais", href: "/mg/emendas-federais" },
        { label: "Emendas estaduais (LOA)", href: "/mg/emendas-estaduais" },
        { label: "Doações e comodatos", href: "/mg/doacoes" },
        { label: "Acordo Vale/Brumadinho", href: "/mg/reparacao" },
        { label: "Pessoal · Acordo Vale", href: "/mg/pessoal-vale" },
        { label: "Voos oficiais do Governador", href: "/mg/voos" },
        { label: "Diárias por órgão", href: "/mg/diarias" },
        { label: "Restos a pagar por órgão", href: "/mg/restos" },
        { label: "Despesa com pessoal · LRF", href: "/mg/lrf" },
        { label: "Credenciados IPSEMG", href: "/mg/ipsemg" },
      ],
    },
    {
      label: "Mais",
