...
export const alt = "ALERJ — A única assembleia do Sudeste sem dados abertos de despesas de gabinete";
      ...
      >
        ...
        <div style={{ display: "flex", flex: 1, alignItems: "center", marginTop: 36 }}>
          <div style={{ display: "flex", gap: 32, alignItems: "stretch", width: "100%" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
              ...
              >
                <span>A única que ainda</span>
                <span style={{ fontStyle: "italic", fontWeight: 700 }}>não abre os dados.</span>
              </h1>
              <p
                style={{
                  fontSize: 28,
              ...
              >
                Entre as três grandes do Sudeste, só a ALERJ não publica despesas de
                gabinete com identificação do fornecedor. Acompanhe o pedido LAI em curso.
              </p>
            </div>
          </div>
        </div>
        ...
        >
          <span style={{ fontFamily: "monospace", fontWeight: 600, color: FG }}>
            alerj.transparenciafederal.org
          </span>
          <span style={{ display: "flex", gap: 10, alignItems: "center" }}>
            <span style={{ width: 8, height: 8, background: FG }} />
            <span>Pedido LAI em curso · Lei 12.527/2011</span>
          </span>
        </div>
      </div>
    ),
